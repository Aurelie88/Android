...
public class RequeteSQLPromotion extends AsyncTask<String, Void, String>{

    private ActiviteEnAttenteAvecResultat activite;
    private PromotionDao dao;

    public RequeteSQLPromotion(ActiviteEnAttenteAvecResultat activite, PromotionDao dao){
